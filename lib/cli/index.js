...
// program
// 	.command('serve')
// 	.description('Boot mage HTTP server')
// 	.action(function () {
// 		console.log("SERVE!!!!");
// 		mage.setTask('serve', null)
// 		mage.setup();
// });
// HACK end
...
exports.run = function () {
	...
	try {
		...
		console.log('[ERROR] COMMANDER complains with your command');
		console.dir(err);
	}
	console.log('Cli parsed commands successfully.');
	// HACK end
