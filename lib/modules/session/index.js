...
function getActorSession(state, actorId, cb) {
	...
	state.archivist.get('session', { actorId: actorId }, options, function (error, data) {
		...
		logger.debug('Session found for actor actorId:', actorId);
		logger.debug('Session found for actor data.actorId:', data["actorId"]);
		logger.debug('Session found for actor session:', session);
		logger.debug('Session found for actor data:', data);
		// logger.trace('Session found for actor session:', session);
		// logger.trace('Session found for actor data:', data);
